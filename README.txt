...
3. Open `scripts/make_ascii_svg.py` and update lines 106 & 141 with your name:
   - The default profile handle is `harsh@github`; use `GH_PROFILE_USER` to override it.
   - The default display name is `Harsh Dubey`; use `PROFILE_FULL_NAME` to override it.
4. Generate the animated ASCII portrait SVG:
     python scripts/make_ascii_svg.py source-prepped.png harsh-ascii.svg
   The generated file uses the current profile identity and keeps the terminal-style animation.
...
1. Open `scripts/make_wordmark_svg.py`:
   - Set `TEXT = "HARSH"` for this profile.
...
Run the heatmap generator for HarshDubey79:
  python scripts/generate_streak_svg.py HarshDubey79 contrib-heatmap.svg
This creates a borderless, transparent animated SVG with pop-and-flash effects.

--- Step E: Customize README.md ---
`README.md` is already configured for HarshDubey79:
  ...
  - X: https://x.com/HarshDubey7985
  - Email: harshdubey3340@gmail.com
  - Main project: SkillNex-AI
  - Tagline: MCA Student · Web Developer · AI & Full-Stack Enthusiast
...
2. Enter the repository name exactly as `HarshDubey79`
...
Now, in your local folder terminal, run:
  ...
  git branch -M main
  git remote add origin https://github.com/HarshDubey79/HarshDubey79.git
...
The workflow is configured with `GH_PROFILE_USER: HarshDubey79`, so it fetches this profile's public contribution data.
...
================================================================================
Done! Visit https://github.com/HarshDubey79 to admire your new profile!
================================================================================
