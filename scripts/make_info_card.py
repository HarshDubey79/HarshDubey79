...
ROWS = [
    ("host",),
    ("kv", "Name",      "Harsh Dubey"),
    ("kv", "Role",      "MCA Student & Web Developer"),
    ("kv", "Focus",     "AI-powered web applications"),
    ("kv", "Education", "Lloyd Institute of Engineering & Technology"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend",  "React · Next.js · JavaScript"),
    ("kv", "Backend",   "Node.js · Express.js · Django · Spring Boot"),
    ("kv", "Database",  "PostgreSQL · SQL · MongoDB"),
    ("kv", "AI / ML",   "Python · NumPy · Pandas · Scikit-learn · Gemini"),
    ("kv", "Tools",     "Git · GitHub · Docker · VS Code"),
    ("gap",),
    ("sec", "Building"),
    ("bul", "SkillNexAI — AI job preparation platform"),
    ("bul", "Resume analysis & technical question generation"),
    ("bul", "Voice mock interviews & interview feedback"),
    ("gap",),
    ("sec", "Links"),
    ("kv", "GitHub",    "github.com/HarshDubey79"),
    ("kv", "LinkedIn",  "in/harsh-dubey-317556328"),
    ("kv", "Email",     "harshdubey3340@gmail.com"),
]
