...
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(HERE, "..", "harsh-ascii.svg")
...
USER_HANDLE = os.environ.get("GH_PROFILE_USER", "harsh")
FULL_NAME = os.environ.get("PROFILE_FULL_NAME", "Harsh Dubey")
